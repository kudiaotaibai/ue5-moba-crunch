...
{
	if (UInventoryItemWidget* OtherWight = Cast<UInventoryItemWidget>(InOperation->Payload))
	{
		if (OtherWight&&!OtherWight->IsEmpty())
		{
			OnInventoryItemDropped.Broadcast(this,OtherWight);
			return true;

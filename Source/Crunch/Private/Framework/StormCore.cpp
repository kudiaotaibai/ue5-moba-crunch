...
AStormCore::AStormCore()
{
	...
	GroundDecalComponent = CreateDefaultSubobject<UDecalComponent>("GroundDecal");
...
void AStormCore::UpdateTeamWidget()
{
	OnTeamInfluencerCountUpdated.Broadcast(TeamOneInfluenceCount,TeamTwoInfluenceCount);
	...
	UE_LOG(LogTemp, Warning, TEXT("Team Weight : %d ,%d ,%f"), TeamOneInfluenceCount,TeamTwoInfluenceCount,TeamWeight);
	UpdateGoal();
}

                                ...
                                const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	UE_LOG(LogTemp,Warning,TEXT("Activated shoot"))
...
{
	UE_LOG(LogTemp,Warning,TEXT("ShootAbility End"));
	K2_EndAbility();
}
...
{
	UE_LOG(LogTemp,Warning,TEXT("StartShoot"));
...
{
	UE_LOG(LogTemp,Warning,TEXT("StartShoot2"));
	if (ShootMontage)
	{
...
{
	UE_LOG(LogTemp,Warning,TEXT("StartShoot3"));
	if(K2_HasAuthority())
	{
...
void UGA_Shoot::StartAimTargetCheckTimer()
{
	...
	if (World)
	{
		World->GetTimerManager().SetTimer(AimTargetCheckTimeHandle,this,&UGA_Shoot::FindAimTarget,AimTargetCheckTimeInterval,true);
	}
}
...
void UGA_Shoot::StopAimTargetCheckTimer()
{
	...
	if (World)
	{
		World->GetTimerManager().ClearTimer(AimTargetCheckTimeHandle);
	}
}
